...
import com.bornfire.xbrl.entities.BRF.BRF_DEMO;
...
public class BRFReportService {

	private static final Logger logger = LoggerFactory.getLogger(BRFReportService.class);
	...
	public String preCheck(String reportid, String fromdate, String todate) {
			...
			try {
				...
				Long dtlcnt = (Long) hs.createQuery("select count(*) from BRF_DEMO a where a.report_date=?1")
						.setParameter(1, dt9).getSingleResult();

				if (dtlcnt > 0) {
					logger.info("Getting No of records in Mod table :" + reportid);
					Long modcnt = (Long) hs.createQuery("select count(*) from BRF_DEMO a").getSingleResult();
					if (modcnt > 0) {
						msg = "success";
					}
				} else {
	...
	public ModelAndView getBRFView(String reportId, String fromdate, String todate, String currency, String dtltype,
			Pageable pageable) {
			...
			List<BRF_DEMO> T1rep = new ArrayList<BRF_DEMO>();
			// Query<Object[]> qr;

			List<BRF_DEMO> T1Master = new ArrayList<BRF_DEMO>();
			...
			//	T1rep = t1CurProdServiceRepo.getT1CurProdServices(d1);
				...
				T1Master = hs.createQuery("from  BRF_DEMO a where a.report_date = ?1 ", BRF_DEMO.class)
	...
	public ModelAndView getBRFDetail(String reportId, String fromdate, String todate, String currency,
		...
		mv.setViewName("RR"+"/"+"BRF::reportcontent");
